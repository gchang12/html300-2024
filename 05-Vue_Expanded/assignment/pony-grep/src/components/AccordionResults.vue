  ...
  <div class="accordion">
    <div class="accordion-item">
      <h3 class="accordion-header">
        ...
        <b-button v-b-toggle="'collapse-' + collapseKey" :data-series="seriesName" class="ShowResults d-flex justify-content-between btn btn-lg btn-block accordion-button" aria-expanded="true" aria-controls="collapseOne">
          <slot name="header">
          </slot>
        </b-button>
      </h3>
      <b-collapse :id="'collapse-' + collapseKey" aria-labelledby="headingOne">
